		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="card">
				<div class="card-body p-0">
                  ...
                  <img src="<?= base_url('assets/'); ?>img/spk/spk-wedding.png"/>
									</a>
								</div>
						...
						<div class="invoice-body">
                          ...
                          <b>Tanggal</b>
													...
													<td><?php if($wedding['date_w'] == '0000-00-00'){
                                                                    echo '-';
                                                                }else {
                                                                    echo date("d/m/Y", strtotime($wedding['date_w'])); 
                                                                } 
                                                                ?></td>
												</tr>
												<tr>
                          ...
                          <b>Team</b>
													...
													<td>Photographer: <?= $wedding['photograper'] ?>,&emsp; Videographer: <?= $wedding['videograper'] ?>,&emsp; Crew: <?= $wedding['crew'] ?></td>
												</tr></br>
                        <tr>
													<th>
                          <b>Detail Event</b>
                        ...
                        <tr>
                          ...
                          <b>Lokasi Event</b>
													...
													<td><?= $wedding['place_w'] ?></td>
												</tr>
                        <tr>
													<td>
                          <b>Jam Event</b>
													</td>
													<td>Akad: <?= $wedding['w_akad'] ?> &emsp;&emsp;Wedding: <?= $wedding['w_resepsi'] ?></td>
												</tr>
                        <tr>
													<td>
                          <b>Contact Person</b>
