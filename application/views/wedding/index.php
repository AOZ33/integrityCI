...
<head>
    ...
    <?php if($this->session->flashdata('flash') ): ?>
        ...
        <?php endif;?>
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Data Spk Wedding</h1>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-body">
            <div class="row">
                    <div class="col-md-4">
                        <form action="<?= base_url('Wedding') ;?>" method="post">
                                ...
                                <tr>
                                    ...
                                    <td> 
                                        <div class="dropdown col-md-6    ">
                                            ...
                                            <a class="dropdown-item" href="<?= base_url(); ?>spk/detail_wed/<?= $spk['id']; ?>">Detail</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    <div class="dropdown col-md-6    ">
                                            ...
                                            if (!empty($row)) {?>
                                            <a class="dropdown-item" href="<?= base_url(); ?>personal/p_wedding_f/<?= $spk['id']; ?>/<?= $row; ?>">Detail <?= $row ?></a>
                                            <?php } } 
                                            foreach ($dvideographer as $row ) {
                                            if (!empty($row)) {?>
                                            <a class="dropdown-item" href="<?= base_url(); ?>personal/p_wedding_v/<?= $spk['id']; ?>/<?= $row; ?>">Detail <?= $row ?></a>
                                            <?php } }
                                            foreach ($dcrew as $row ) {
                                            if (!empty($row)) {?>
                                            <a class="dropdown-item" href="<?= base_url(); ?>personal/p_wedding_c/<?= $spk['id']; ?>/<?= $row; ?>">Detail <?= $row ?></a>
                                            <?php } }?>
                                            </div>
                                        </div>
                                    </td>
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit<?= $id; ?>" class="modal fade">
            <div class="modal-dialog " style="max-width: 40%;" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?= base_url('wedding/spk_edit ') ?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body row">
                            <div class="col-6" id="frm-field">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        Mulai:
                                        <input type="text" class="form-control" name="w_akad" id="w_akad" value="<?php if($spk['w_akad'] == '00:00:00'){
                                            echo '-';
                                        }else {
                                            echo ($spk['w_akad']); 
                                        } 
                                         ?>">
                                         Selesai:
                                        <input type="text" class="form-control" name="w_resepsi" id="w_resepsi" value="<?php if($spk['w_resepsi'] == '00:00:00'){
                                            echo '-';
                                        }else {
                                            echo ($spk['w_resepsi']); 
                                        } 
                            ...
                            <div class="col-6" id="frm-field">
                                ...
                                <div class="col-md-6  ">
                                    <label for="more" class="form-label">Detail Tim (Harap Di Ceklis Kembali)</label>
                                </div>
        ...
        <div class="modal fade" id="delete<?= $id; ?>" tabindex="-1" aria-labelledby="delete" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url() ?>wedding/hapus_data/<?= $ap['id'] ?>" method="post">
