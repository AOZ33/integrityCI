		...
		<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
			<div class="card">
				<div class="card-body p-0">
                  ...
                  <img src="<?= base_url('assets/'); ?>img/spk/spk-acara.png"/>
									</a>
								</div>
						...
						<div class="invoice-body">
                          ...
                          <b>Team</b>
													...
													<td>Photographer: <?= $acara['photograper'] ?>,&emsp; Videographer: <?= $acara['videograper'] ?>,&emsp; Crew: <?= $acara['crew'] ?></td>
												</tr></br>
                        <tr>
													<th>
                          <b>Detail Event</b>
...
<div class="modal-dialog" style="max-width: 95%;" role="document">
  ...
  <tbody>
    ...
    <tr>
        ...
        <td><?= $acara['photograper'] ?>,<?= $acara['videograper'] ?>,<?= $acara['crew'] ?></td>
