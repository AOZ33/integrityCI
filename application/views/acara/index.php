...
<head>
    <link rel="icon" type="image/png" href=<?= base_url('assets/img/nsnmt-01.png'); ?>>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
        ...
        <?php endif; ?>
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Data Spk Acara</h1>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4">
                        <form action="<?= base_url('Acara'); ?>" method="post">
                                    ...
                                    <td>
                                        <div class="dropdown col-md-6    ">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item" href="<?= base_url(); ?>spk/detail_lain/<?= $spk['id']; ?>">Detail</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit<?= $id; ?>" class="modal fade">
            <div class="modal-dialog " style="max-width: 40%;" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?= base_url('acara/spk_edit ') ?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body row">
                            <div class="col-6" id="frm-field">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="w_lain" id="w_lain" value="<?php if ($spk['w_lain'] == '00:00:00') {
                                                                                                                        echo '-';
                                                                                                                    } else {
                                                                                                                        echo ($spk['w_lain']);
                                                                                                                    }
                            ...
                            <div class="col-6" id="frm-field">
                                <div class="form-group  ">
                                    ...
                                    <div class="mb-3">
                                        <textarea class="form-control" name="place_a" id="place_a" rows="3" placeholder="Tempat Acara"><?php echo $place_a; ?></textarea>
                                        <hr class="sidebar-divider d-none d-md-block">
                                    </div>
                                </div>
                                <div class="col-md-6  ">
        ...
        <div class="modal fade" id="delete<?= $id; ?>" tabindex="-1" aria-labelledby="delete" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url() ?>acara/hapus_data/<?= $ap['id'] ?>" method="post">
