...
<head>
    ...
    <?php if($this->session->flashdata('flash') ): ?>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="row">
                    <div class="col-md-4">
                        <form action="<?= base_url('Lamaran') ;?>" method="post">
                            ...
                            <?php foreach ($surat as $spk) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown col-md-6    ">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item" href="<?= base_url(); ?>spk/detail_lamar/<?= $spk['id']; ?>">Detail Tim</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    <div class="dropdown col-md-6    ">
                                            ...
                                            if (!empty($row)) {?>
                                            <a class="dropdown-item" href="<?= base_url(); ?>personal/p_lamar_f/<?= $spk['id']; ?>/<?= $row; ?>">Detail <?= $row ?></a>
                                            <?php } } 
                                            foreach ($dvideographer as $row ) {
                                            if (!empty($row)) {?>
                                            <a class="dropdown-item" href="<?= base_url(); ?>personal/p_lamar_v/<?= $spk['id']; ?>/<?= $row; ?>">Detail <?= $row ?></a>
                                            <?php } }
                                            foreach ($dcrew as $row ) {
                                            if (!empty($row)) {?>
                                            <a class="dropdown-item" href="<?= base_url(); ?>personal/p_lamar_c/<?= $spk['id']; ?>/<?= $row; ?>">Detail <?= $row ?></a>
                                            <?php } }?>
                                            </div>
                                        </div>
                                    </td>
                    ...
                    <form class="form-horizontal" action="<?= base_url('lamaran/spk_edit ') ?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body row">
                            <div class="col-6" id="frm-field">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="w_lamaran" id="w_lamaran" value="<?php if($spk['w_lamaran'] == '00:00:00'){
                                            echo '-';
                                        }else {
                                            echo ($spk['w_lamaran']); 
                                        } 
                            ...
                            <div class="col-6" id="frm-field">
                                ...
                                <div class="col-md-6  ">
                                    <label  class="form-group">Detail Tim (Harap Di Ceklis Kembali)</label>
                                </div>
