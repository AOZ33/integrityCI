...
<head>
    ...
    <?php if($this->session->flashdata('flash') ): ?>
        ...
        <?php endif;?>
        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800">Data Spk Live Stream</h1>
        <!-- DataTales Example -->
        <div class="card shadow mb-4">
            <div class="card-body">
            <div class="row">
                    <div class="col-md-4">
                        <form action="<?= base_url('Live') ;?>" method="post">
                            ...
                            <?php foreach ($surat as $spk) : ?>
                                <tr>
                                    ...
                                    <div class="dropdown col-md-6    ">
                                            ...
                                            <a class="dropdown-item" href="<?= base_url(); ?>spk/detail_live/<?= $spk['id']; ?>">Detail</a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit<?= $id; ?>" class="modal fade">
            <div class="modal-dialog " style="max-width: 40%;" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?= base_url('live/spk_edit ') ?>" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body row">
                            <div class="col-6" id="frm-field">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="w_live" id="w_live" value="<?php if($spk['w_live'] == '00:00:00'){
                                            echo '-';
                                        }else {
                                            echo ($spk['w_live']); 
                                        } 
                            ...
                            <div class="col-6" id="frm-field">
                                <div class="form-group  ">
                                    ...
                                    <div class="mb-3">
                                    <textarea class="form-control" name="place_s" id="place_s" rows="3" placeholder="Tempat Wedding"><?php echo $place_s; ?></textarea>
        ...
        <div class="modal fade" id="delete<?= $id; ?>" tabindex="-1" aria-labelledby="delete" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url() ?>live/hapus_data/<?= $ap['id'] ?>" method="post">
