...
<head>
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form class="row" action="<?= base_url('data/add_techmeet') ?>" method="post">
                    <div class="container">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <input type="date" class="form-control" data-provide="datepicker" name="date_w" id="date_w" value="<?= $appointment['date_w'] ?>">   
                                <label for="date_w" class="form-label">Jam Akad </label>
                                <input type="text" class="form-control" name="w_akad" id="w_akad" value="<?= $appointment['w_akad'] ?>">   
                                <label for="date_w" class="form-label">Jam Resepsi</label>
                                <input type="text" class="form-control" name="w_resepsi" id="w_resepsi" value="<?= $appointment['w_resepsi'] ?>">   
                                <label for="date_w" class="form-label">Tempat Wedding </label>
                                <textarea class="form-control" name="place_w" id="place_w" rows="1" ><?= $appointment['place_w'] ?></textarea>
                                <label for="package" class="form-label">Paket</label>
                                <input type="text" name="package" class="form-control" id="package" value="<?= $appointment['package'] ?>">
                            </div>
                            <div class="col-6">
                                <h5>Liputan Pengajian & Siraman</h5>
                                <hr class="sidebar-divider d-none d-md-block">
                                <label for="date_s" class="form-label">Tanggal</label>
                                <input type="date" class="form-control" data-provide="datepicker" name="date_s" id="date_s" value="<?= $appointment['date_m'] ?>"> 
                                <label for="place_s" class="form-label">Tempat</label>
                                <textarea class="form-control" name="place_s" id="place_s" rows="1" ><?= $appointment['place_m'] ?></textarea> 
                                <label for="w_pengsir" class="form-label">Jam</label>
                                <input type="text" class="form-control" name="w_pengsir" id="w_pengsir" value="<?= $appointment['w_siram'] ?>" >
                                <ul >
                                    <li class="mb-2 mt-4">
                            ...
                            <div class="col-6 ">
                                ...
                                <ul>
                                    <li class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="tim" id="tim" placeholder="Jumlah Tim">
                                        <input type="text" class="form-control" name="fotograper" id="fotograper" placeholder="Fotograper">
                                        <input type="text" class="form-control" name="videograper" id="videograper" placeholder="Videograper">
                                        <input type="text" class="form-control"     name="crew" id="crew" placeholder="Crew" >
                                    </li>
                                    <li class="mb-2">
                                    ...
                                    <li class=" mb-2">
                                        ...
                                        <div  class="input-group">
                                            <input type="text" name="u_prewedd" class="form-control" id="u_prewedd"  value="<?= $appointment['ukuran_p'] ?>">
                                    ...
                                    <li class=" mb-2">
                                        ...
                                        <div  class="input-group">
                                            <input type="text" name="u_prewedd4r" class="form-control" id="u_prewedd4r" value="<?= $appointment['photo_g'] ?>">
                                    ...
                                    <li class="mb-2">
                                        Tempat Make Up
                                    <input type="text" name="place_m" class="form-control" id="place_m" >
                                    </li>
                                    <li >
                                        Jam Make Up
                                    <input type="text" name="w_makeup" class="form-control" id="w_makeup" >
                                    </li>
                                </ul>
                            </div>
                            <div class="col-6 ">
                                ...
                                <input type="text" name="box" class="form-control" id="box" value="<?= $appointment['box'] ?>">
                                <label for="name" class="form-label">Album Wedding Ukuran</label>
                                <input type="text" name="ukuran_a" class="form-control" id="ukuran_a" value="<?= $appointment['u20x30'] ?><?= $appointment['u25x30'] ?><?= $appointment['u30x30'] ?>" >
                                <label for="name" class="form-label">Foto Wedding Ukuran</label>
                                <input type="text" name="ukuran_w" class="form-control" id="ukuran_w" value="<?= $appointment['ukuran_w'] ?>" >
                                <label for="name" class="form-label">Video Highlight</label>
                                <input type="text" name="vid_h" class="form-control" id="vid_h" >                           
                                <label for="name" class="form-label">Video Wedding</label>
                                <input type="text" name="vid_wedding" class="form-control" id="vid_wedding" value="<?= $appointment['video'] ?>">                          
                                <label for="name" class="form-label">Note</label>
                                <textarea class="form-control" name="note" id="note" rows="5" ><?= $appointment['tambahan'] ?>,<?= $appointment['lainnya'] ?></textarea> 
                            </div>
                        </div>
                        <hr class="sidebar-divider d-none d-md-block">
                    </div>
