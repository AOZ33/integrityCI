...
class Live extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = 'http://localhost/NESNUMOTO/integrity/live/index/';
        $this->db->like('name', $data['keyword']);
        $this->db->or_like('phone', $data['keyword']);
        $this->db->or_like('date_s', $data['keyword']);
        $this->db->or_like('place_s', $data['keyword']);
        $this->db->or_like('w_live', $data['keyword']);
        ...
        $data['surat'] = $this->Live_model->getSpk($config['per_page'],$data['start'],$data['keyword']);
    ...
    function spk_edit()
    {
        ...
        if ($_POST) {
            ...
            $this->Live_model->spk_edit($data, $id);
