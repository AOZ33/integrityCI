...
class Acara extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = 'http://localhost/NESNUMOTO/integrity/acara/index/';
        $this->db->like('name_a', $data['keyword']);
        $this->db->like('name', $data['keyword']);
        $this->db->or_like('phone', $data['keyword']);
        $this->db->or_like('date_a', $data['keyword']);
        $this->db->or_like('place_a', $data['keyword']);
        $this->db->or_like('w_lain', $data['keyword']);
        ...
        $data['surat'] = $this->Acara_model->getSpk($config['per_page'],$data['start'],$data['keyword']);
    ...
    function spk_edit()
    {
        ...
        if ($_POST) {
            ...
            $this->Acara_model->spk_edit($data, $id);
    ...
    {
        $this->Acara_model->hapus_data($id);
